...
const apiService = {
  // Récupère le profil admin connecté via l’API.
  async getProfile(): Promise<{ success: boolean; data: AdminProfileData }> {
  ...
  // Met à jour le mot de passe de l’admin après vérification.
...
const MonProfilAdmin: React.FC = () => {
  ...
  // Charge les informations du profil au montage du composant.
  useEffect(() => {
    fetchProfile();
  }, []);

  // Charge les données du profil et initialise le formulaire email.
  ...
  // Met à jour l’adresse email de l’admin via l’API.
  ...
  // Met à jour le mot de passe après vérifications locales puis API.
  ...
  // Affiche un message temporaire (succès ou erreur) en bas de l’écran.
    ...
    return (
      <Container maxWidth="lg" sx={{ py: 5 }}>
        <Box display="flex" justifyContent="center" alignItems="center" minHeight="60vh">
          <Typography sx={{ fontFamily: 'Montserrat', color: '#C5A028' }}>
            Chargement...
          </Typography>
        </Box>
      </Container>
      ...
      <Container maxWidth="md">
        ...
        >
          <Box sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
            ...
            >
              Administrateur de La Ruche Académie
            </Typography>
          </Box>
          <Box
            sx={{
        ...
        {/* Dialogs - identiques au profil étudiant mais avec les couleurs formateur */}
        <Dialog
          open={editingEmail}
